...
.container {
    width: 180px;
    min-height: 96px; /* Asegura que haya suficiente espacio */
    padding: 0;
    margin: 0;
...
.plan {
	...
	height: auto;
    position: absolute;
    top: 6px; /* Justo arriba del precio */
    left: 20px;
    font-weight: bold;
    font-size: 16px;
...
.precio {
    position: absolute;
    bottom: 5px; /* Ajustado para que esté debajo del perfil */
    left: 4px;
    width: auto;
    color: #777;
    font-weight: bold;
...
<div class="container">
    ...
    <!-- NUMERO DE PERFIL -->
    <div style="position: relative; width: 15px; height: 15px; border: 1px solid #fff;">
        <div style="position: absolute; top: 4px; left: 6px; color: #333; font-size: 14px; font-weight: bold;">
    ...
    $tipos = [
		...
		"z3-HORAS" => '<img src="https://flagcdn.com/mx.svg" width="21px" alt="Bandera de México"> 3 HORAS',
		"4-HORAS" => '<img src="https://flagcdn.com/mx.svg" width="21px" alt="Bandera de México"> 6 HORAS',
