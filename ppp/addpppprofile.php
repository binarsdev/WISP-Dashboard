...
?>
<div class="row"><div class="col-8"><div class="card"><div class="card-header"><h3><i class="fa fa-plus"></i> Add PPP Profile</h3></div><div class="card-body">
...
<table class="table"><tr><td>Name</td><td><input class="form-control" name="name" required></td></tr><tr><td>Local Address</td><td><input class="form-control" name="localaddr"></td></tr><tr><td>Remote Address</td><td><input class="form-control" name="remoteaddr"></td></tr><tr><td>Rate Limit</td><td><input class="form-control" name="ratelimit" placeholder="1M/1M"></td></tr><tr><td>Only One</td><td><select class="form-control" name="onlyone"><option value="yes">yes</option><option value="no">no</option></select></td></tr></table>
